...
> **MCP tool and prompt implementation**: see [mcp-tools.instructions.md](.github/instructions/mcp-tools.instructions.md) — auto-loaded for `src/**/Tools/**` and `src/**/Prompts/**`.

> **Authentication, authorization, and configuration patterns**: see [mcp-infrastructure.instructions.md](.github/instructions/mcp-infrastructure.instructions.md) — auto-loaded for `src/**/Infrastructure/**`.
