...
| `entra-id.tf` | 3 app registrations (`app-backend-api`, `app-mcp-server`, `app-foundry-agent`), Application ID URIs (`api://<client_id>`) for all 3 apps, 3 service principals, 2 app passwords |
