...
/// </summary>
/// <remarks>
/// OBO-mandatory, no token passthrough. See McpServer.Presentation/README.md § OBO Security Posture.
/// Base URL set via <see cref="HttpClient.BaseAddress"/> from <see cref="McpServer.Application.Configuration.DownstreamApiOptions.BaseUrl"/>.
